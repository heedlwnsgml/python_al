  ...
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "text": [
      "현재 등록된 도서 목록:\n",
      "[책 번호: 1000, 제목: 자료구조와 알고리즘, 저자: 이ㅏ, 출판 연도: 20]  \n",
      "\n",
      "=== 도서 관리 프로그램 ===\n",
      "1. 도서 추가\n",
      "2. 도서 삭제 (책 제목으로 삭제)\n",
